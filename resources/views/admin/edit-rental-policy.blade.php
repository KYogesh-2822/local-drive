...
<section class="dashboard">
    ...
    <form action="{{route('admin.policy.editRentalPolicy')}}" method="post">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea class="form-control summernote" name="detail" id="detail" rows="3" required>{{$data->detail ?? ''}}</textarea>
        </div>
