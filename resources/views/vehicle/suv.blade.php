    ...
    <div class="breadcrumb">
        <div class="container-fluid">
            <ul class="d-flex breadcrumb-list">
                ...
                <li><a href="{{route('vehicle.suvs')}}">All Cars in Jordan</a></li>
            </ul>
        </div>
    </div>

    <section class="hero-sec-txt" style="background-image: url('{{asset('images')}}/{{$suv->banner_image}}');">
        <div class="container">
            <div class="txt">
                {!! $suv->banner_content !!}
                <!-- <a class="btn" href="{{route('vehicle.car')}}">{{$suv->banner_button}}</a> -->
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="btn-grid text-end">
                        <a class="btn btn-bdr" href="{{route('reservation')}}">{{$suv->button}}</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="d-flex vehicle-types-main-grid img-png-wit">
                ...
                <div class="vehicle-grid">
                    ...
                    <div class="txt">
                        <h5><a href="#">All {{$other->type == 'pickup' ? 'Trucks' : ($other->type == 'car' ? 'Cars' : 'Vans')}} in Jordan</a></h5>
                        <p>
                        ...
                        <?php 
                            ...
                            }elseif($other->type == 'car'){
                                $route = 'vehicle.car';
                            }else{
                                $route = 'vehicle.vans';
                            }   
                            ?>
                            <a class="btn btn-bdr" href="{{route($route)}}">View All {{$other->total}} {{$other->type == 'pickup' ? 'Trucks' : ($other->type == 'car' ? 'Cars' : 'Vans')}} Classes</a>
                        </div>
                    </div>
                </div>
                @endforeach
